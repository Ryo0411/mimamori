    ...
    fetch('/speaker_rcognition', options)
        ...
        .then(response => {
            ...
            if (response['status'] === 0) {
                ...
                document.getElementById("exe_result").innerHTML = "<p>データ取得に問題が発生しました。<br>ブラウザを再起動して、もう一度お試しください。</p>";
                document.getElementById("errorrelode").innerHTML = "データ取得に問題が発生しました。<br>ブラウザを再起動して、もう一度お試しください。<br>（OKをクリックすると再起動します）";
