...
const fixed_text = [
    '本日息子と二人で釣り船に乗り、大きなアジを3尾釣ることができました。<br/>家に帰ってアジフライし、美味しく頂きました。',
    '本日家族が一人増えました、名前はポチです。<br/>産まれてまだ一か月の子犬です、色は黒でとっても甘えん坊です。',
    '私の趣味は家庭菜園です、この間初めてナスを育てました。<br/>大きく立派に育ったので夏野菜カレーにして頂きました。',
    'この間散歩に出かけた際に雨が降ってきてしまいました。<br/>傘を持っていなかった為、1時間ほど雨宿りをしました。',
    '今日に夕飯はカレーです。<br/>私の家では隠し味にチョコレートを入れます。<br/>甘さとコクが増しとても美味しいです。',
];
